...
Label_0=Label(root, text="Your Account", width=20, fg="blue", font=("bold",20))
Label_0.place(x=90,y=33)

Label_1=Label(root, text="Your Email Account:", width=20,fg="red", font=("bold",10))
...
compose=Label(root, text="Compose", width=20,fg="blue", font=("bold",15))
compose.place(x=180,y=210)

Label_3=Label(root, text="Sent To Email:", width=20,fg="red", font=("bold",10))
...
Label_4=Label(root, text="Subject:", width=20,fg="red", font=("bold",10))
...
Label_5=Label(root, text="Message:", width=20,fg="red", font=("bold",10))
...
Label_7=Label(root, text="</Developed By:-Sahil kumar/> ", width=80,fg="red", font=("bold",10))
